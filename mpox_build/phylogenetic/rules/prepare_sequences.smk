...
rule download:
    ...
    output:
        ...
        metadata="data/metadata_temp.tsv.gz",
    params:
...
rule decompress:
    ...
    output:
        ...
        metadata="data/metadata_temp.tsv",
    shell:
        """
...
rule add_focus_areas:
    """
    Adding in focus area for mpox LA analysis
    """
    input: 
        metadata = "data/metadata_temp.tsv"
    output:
    ...
    shell:
        """
        python3 scripts/add_focus_area.py \
